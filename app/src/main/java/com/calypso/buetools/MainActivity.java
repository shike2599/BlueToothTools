    ...
    public void initBlueManager() {
        ...
        onSendMessageListener = new OnSendMessageListener() {
            ...
            public void onSuccess(int status, String response) {
                sendMessage(0, "发送成功！");
                Log.i(TAG,  "send message is success ! ");
            }

            @Override
            public void onConnectionLost(Exception e) {
                sendMessage(0, "连接断开！");
                Log.i(TAG,  "send message is onConnectionLost ! ");
            }

            @Override
            public void onError(Exception e) {
                sendMessage(0, "发送失败！");
                Log.i(TAG, "send message is onError ! ");
            }
        };
        onReceiveMessageListener = new OnReceiveMessageListener() {
            ...
            public void onDetectDataFinish() {
                sendMessage(2, "接收完成！");
                Log.i(TAG,  "receive message is onDetectDataFinish");
            }
            ...
            public void onConnectionLost(Exception e) {
                sendMessage(0, "连接断开");
                Log.i(TAG, "receive message is onConnectionLost ! ");
            }

            @Override
            public void onError(Exception e) {
                Log.i(TAG,  "receive message is onError ! ");
            }
        };
